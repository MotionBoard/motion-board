...
export type UserData = {
	...
	handedness: string;
	powerFormat: UserPowerFormat;
	heartRateFormat: UserHeartRateFormat;
	...
	firstbeatMaxStressScore: number | null;
	firstbeatCyclingLtTimestamp: number | null;
	firstbeatRunningLtTimestamp: number | null;
	thresholdHeartRateAutoDetected: boolean;
	ftpAutoDetected: unknown;
	trainingStatusPausedDate: unknown | null;
	...
	preferredLongTrainingDays: string[];
};
